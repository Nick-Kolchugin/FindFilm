...
import com.example.findfilm.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Подключаем анимации и передаем номер позиции
        MainActivity.AnimationHelper.performFragmentCircularRevealAnimation(settings_fragment_root, requireActivity(), 5)

        //Слушаем какой сейчас у нас выбран вариант в настройках
        ...
        //Слушатель для отправки нового состояния
